...
![2019-10-20 11-49-47 的屏幕截图](img/2019-10-20 11-49-47 的屏幕截图.png)

#### userRegister

##### 查看帮助

![2019-10-20 11-52-11 的屏幕截图](img//2019-10-20 11-52-11 的屏幕截图.png)

##### 注册用户

![2019-10-20 11-54-22 的屏幕截图](img/2019-10-20 11-54-22 的屏幕截图.png)

以上我们成功注册两个用户，查看`data/userList.json`文件可以看到两个用户的信息都已按照JSON格式保存，如下图：

![2019-10-20 12-01-15 的屏幕截图](img/2019-10-20 12-01-15 的屏幕截图.png)

以下是一些错误尝试，例如：用户名重复、邮箱已被注册、手机不正确等等，会输出相应的错误信息

![2019-10-20 11-59-33 的屏幕截图](img/2019-10-20 11-59-33 的屏幕截图.png)

#### userLogin

##### 查看帮助

![2019-10-20 12-02-37 的屏幕截图](img/2019-10-20 12-02-37 的屏幕截图.png)

##### 用户登录

使用已注册用户登录

![2019-10-20 12-03-46 的屏幕截图](img/2019-10-20 12-03-46 的屏幕截图.png)

再次登录会提示已登录

![2019-10-20 12-05-02 的屏幕截图](img/2019-10-20 12-05-02 的屏幕截图.png)

查看`data/curUser.json`文件可以看到当前登录的用户信息，如下图：

![2019-10-20 12-07-29 的屏幕截图](img/2019-10-20 12-07-29 的屏幕截图.png)

这里我们先登出，尝试使用错误的用户名和密码登录，会输出用户名或密码错误的提示信息。（登出的命令后面会提到）

![2019-10-20 12-08-56 的屏幕截图](img/2019-10-20 12-08-56 的屏幕截图.png)

#### userLogout

##### 查看帮助

![2019-10-20 12-10-04 的屏幕截图](img/2019-10-20 12-10-04 的屏幕截图.png)

##### 用户登出

我们首先登录，然后执行登出命令，可以看到登出成功。若没有登入就执行登出命令，则会输出错误提示。

![2019-10-20 12-11-13 的屏幕截图](img/2019-10-20 12-11-13 的屏幕截图.png)
...
![2019-10-20 12-14-58 的屏幕截图](img/2019-10-20 12-14-58 的屏幕截图.png)